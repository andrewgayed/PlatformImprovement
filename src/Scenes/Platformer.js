class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        this.waterSplash = this.add.particles(0, 0, "kenny-particles", {
            frame: ["circle_05.png", "circle_06.png"],
        ...
        this.physics.add.overlap(my.sprite.player, this.coinGroup, (obj1, obj2) => {
            this.coinParticles.emitParticleAt(obj2.x, obj2.y, 8);
    ...
    update() {
        ...
        if (playerTile && playerTile.properties.water == true) {
            ...
            this.waterSplash.emitParticleAt(
                my.sprite.player.x,
                my.sprite.player.y,
                12
            );
